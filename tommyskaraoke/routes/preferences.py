...
from tommyskaraoke.lib.current_app import broadcast_event, get_karaoke_instance, is_admin
from tommyskaraoke.lib.preference_manager import PreferenceManager
from tommyskaraoke.routes.splash import _get_active_score_phrases
