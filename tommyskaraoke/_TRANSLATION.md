...
Look in `tommyskaraoke/translations` directory and identify the `messages.po` file for a locale/language you can help translate. Fill in all the translations in the file and submit a PR or email the maintainer of tommyskaraoke.
...
from the ./tommyskaraoke subdirectory, run
...
They can also be changed in the web UI's settings menu under "Preferred language" a restart of tommyskaraoke is required.
