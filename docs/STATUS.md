# HomeKaraoke — Implementation Status
...
| 6-stem separation (demucs-MLX) | Done | Apple Silicon Metal GPU, default-on |
...
|-------|----------|-------|
| Songs in wrong download dir | Low | `songs/` dir in project vs `~/pikaraoke-songs/` — configure download_path |
